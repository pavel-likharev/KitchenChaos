...
public class StoveCounter : BaseCounter, IHasProgress
{
    ...
    public override void Interact(Player player)
    {
        if (!HasKitchenObject())
        {
            if (player.HasKitchenObject())
            {
                ...
                if (HasFryingRicipeWithInputKitchenObject(GetKitchenObject().GetKitchenObjectSO()))
                {
    ...
    private bool HasFryingRicipeWithInputKitchenObject(KitchenObjectSO inputKitchenObjectSO)
    {
